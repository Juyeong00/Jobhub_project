...
INSERT ALL
    INTO employee (employee_id, image_path, jobs_id, name, phone, tel, birth, gender, address, hire_date, resignation_date, email) VALUES ('emp1', 'd:/fileStorage/ca593e1f-image1.jpg', 2, '김서연', '010-1111-2222', '02-9999-1111', TO_DATE('1991-05-15', 'YYYY-MM-DD'), '여성', '서울시 강남구 역삼동', TO_DATE('2022-08-15', 'YYYY-MM-DD'), NULL, 'user123@jobhub.com')
    INTO employee (employee_id, image_path, jobs_id, name, phone, tel, birth, gender, address, hire_date, resignation_date, email) VALUES ('emp2', 'd:/fileStorage/ca593e1f-image2.jpg', 3, '이민재', '010-2345-6789', '02-9999-2345', TO_DATE('1990-09-28', 'YYYY-MM-DD'), '남성', '서울시 송파구 잠실동', TO_DATE('2022-11-23', 'YYYY-MM-DD'), NULL, 'john.doe@jobhub.com')
    INTO employee (employee_id, image_path, jobs_id, name, phone, tel, birth, gender, address, hire_date, resignation_date, email) VALUES ('emp3', 'd:/fileStorage/ca593e1f-image3.jpg', 4, '박하늘', '010-8765-4321', '02-9999-8765', TO_DATE('1994-03-07', 'YYYY-MM-DD'), '여성', '서울시 서초구 서초동', TO_DATE('2023-05-07', 'YYYY-MM-DD'), NULL, 'alice_smith@jobhub.com')
    INTO employee (employee_id, image_path, jobs_id, name, phone, tel, birth, gender, address, hire_date, resignation_date, email) VALUES ('emp4', 'd:/fileStorage/ca593e1f-image4.jpg', 5, '최우진', '010-9876-5432', '02-9999-9876', TO_DATE('1995-11-19', 'YYYY-MM-DD'), '남성', '서울시 강서구 화곡동', TO_DATE('2023-02-14', 'YYYY-MM-DD'), NULL, 'jenny_lee@jobhub.com')
    INTO employee (employee_id, image_path, jobs_id, name, phone, tel, birth, gender, address, hire_date, resignation_date, email) VALUES ('emp5', 'd:/fileStorage/ca593e1f-image5.jpg', 6, '정수빈', '010-5432-1098', '02-9999-5432', TO_DATE('1992-08-02', 'YYYY-MM-DD'), '여성', '서울시 강북구 미아동', TO_DATE('2022-10-30', 'YYYY-MM-DD'), NULL, 'mike_jones@jobhub.com')
    INTO employee (employee_id, image_path, jobs_id, name, phone, tel, birth, gender, address, hire_date, resignation_date, email) VALUES ('emp6', 'd:/fileStorage/ca593e1f-image6.jpg', 7, '강태준', '010-6789-1234', '02-9999-6789', TO_DATE('1998-06-11', 'YYYY-MM-DD'), '남성', '서울시 동작구 사당동', TO_DATE('2022-07-12', 'YYYY-MM-DD'), NULL, 'emily.wang@jobhub.com')
    INTO employee (employee_id, image_path, jobs_id, name, phone, tel, birth, gender, address, hire_date, resignation_date, email) VALUES ('emp7', 'd:/fileStorage/ca593e1f-image7.jpg', 8, '한미경', '010-3210-9876', '02-9999-3210', TO_DATE('1996-04-23', 'YYYY-MM-DD'), '여성', '서울시 관악구 봉천동', TO_DATE('2023-09-18', 'YYYY-MM-DD'), NULL, 'david_miller@jobhub.com')
    INTO employee (employee_id, image_path, jobs_id, name, phone, tel, birth, gender, address, hire_date, resignation_date, email) VALUES ('emp8', 'd:/fileStorage/ca593e1f-image8.jpg', 9, '송재우', '010-1111-3333', '02-9999-5555', TO_DATE('1993-12-30', 'YYYY-MM-DD'), '남성', '서울시 중랑구 면목동', TO_DATE('2022-12-05', 'YYYY-MM-DD'), NULL, 'sarah.brown@jobhub.com')
    INTO employee (employee_id, image_path, jobs_id, name, phone, tel, birth, gender, address, hire_date, resignation_date, email) VALUES ('emp9', 'd:/fileStorage/ca593e1f-image9.jpg', 11, '임하윤', '010-4444-5555', '02-9999-4444', TO_DATE('1999-10-05', 'YYYY-MM-DD'), '여성', '서울시 성북구 석관동', TO_DATE('2022-09-03', 'YYYY-MM-DD'), NULL, 'kevin_clark@jobhub.com')
    INTO employee (employee_id, image_path, jobs_id, name, phone, tel, birth, gender, address, hire_date, resignation_date, email) VALUES ('emp10', 'd:/fileStorage/ca593e1f-image10.jpg', 13, '오성민', '010-6666-7777', '02-9999-6666', TO_DATE('1997-01-17', 'YYYY-MM-DD'), '남성', '서울시 동대문구 제기동', TO_DATE('2023-04-27', 'YYYY-MM-DD'), NULL, 'anna.jones@jobhub.com')
    INTO employee (employee_id, image_path, jobs_id, name, phone, tel, birth, gender, address, hire_date, resignation_date, email) VALUES ('emp11', 'd:/fileStorage/ca593e1f-image11.jpg', 14, '유수빈', '010-8888-9999', '02-9999-8888', TO_DATE('1991-07-14', 'YYYY-MM-DD'), '여성', '서울시 강동구 천호동', TO_DATE('2023-08-02', 'YYYY-MM-DD'), NULL, 'brian_smith@jobhub.com')
SELECT * FROM dual;

INSERT INTO employee VALUES ('emp17', 'd:/fileStorage/ca593e1f-image17.jpg', 13, '이수종', '010-8942-1865', '02-9999-1112', '91/04/24', '남성', null, null, null, 'afdsfx@jobhub.com');
INSERT INTO employee VALUES ('emp12', 'd:/fileStorage/ca593e1f-image12.jpg', 19, '김아린', '010-4616-5482', '02-9999-1545', '91/04/24', '여성', null, null, null, 'arin@jobhub.com');
INSERT INTO employee VALUES ('emp13', 'd:/fileStorage/ca593e1f-image13.jpg', 20, '서시우', '010-8915-5615', '02-9999-8612', '96/05/10', '남성', null, null, null, 'afdefe@jobhub.com');
INSERT INTO employee VALUES ('emp14', 'd:/fileStorage/ca593e1f-image14.jpg', 27, '신창현', '010-9122-8121', '02-9999-9151', '91/04/24', '남성', null, null, null, 'ytxs@jobhub.com');
INSERT INTO employee VALUES ('emp15', 'd:/fileStorage/ca593e1f-image15.jpg', 30, '한영현', '010-1892-9163', '02-9999-3158', '91/04/24', '남성', null, null, null, 'rtg4d@jobhub.com');
INSERT INTO employee VALUES ('emp16', 'd:/fileStorage/ca593e1f-image16.jpg', 31, '안예나', '010-6467-0565', '02-9999-9512', '91/04/24', '여성', null, null, null, 'grdawd@jobhub.com');
